...
namespace CCSheet.Menus
{
	...
	{
		internal static string CSText(string key, string category = "Teleport") => CCSheet.CSText(category, key);
		...
		public QuickTeleportHotbar(CCSheet mod) {
			this.mod = mod;
