...
namespace CCSheet.Menus
{
	internal class NPCSlot : UIView
	{
		...
		//	netMessage.Write((byte)CCSheetMessageType.RequestToggleNPCSpawn);
		...
		//{
		//	int useValue = netID;
		//	NPCSlot slot = ((CCSheet)CCSheet.instance).npcBrowser.npcView.allNPCSlot[whoAmI];
		...
		//{
		//	var netMessage = CCSheet.instance.GetPacket();
		//	netMessage.Write((byte)CCSheetMessageType.FilterNPC);
		//	netMessage.Write(whoAmI);
		//	netMessage.Send();
		//}
