...
namespace CCSheet.UI
{
	internal class UITextbox : UIView
	{
		...
		public UITextbox() {
			textboxBackground = CCSheet.instance.Assets.Request<Texture2D>("UI/Images.UIKit.textboxEdge", AssetRequestMode.ImmediateLoad);
		...
		public override void Draw(SpriteBatch spriteBatch) {
			...
			if (pos.X <= Main.screenWidth && pos.Y <= Main.screenHeight && pos.X + Width >= 0 && pos.Y + Height >= 0) {
				...
				cutRect = CCSheet.GetClippingRectangle(spriteBatch, cutRect);
