...
namespace CCSheet.UI
{
	internal class UICheckbox : UIView
	{
		...
		public UICheckbox(string text) {
			checkboxTexture = CCSheet.instance.Assets.Request<Texture2D>("UI/checkBox", AssetRequestMode.ImmediateLoad);
			checkmarkTexture = CCSheet.instance.Assets.Request<Texture2D>("UI/checkMark", AssetRequestMode.ImmediateLoad);
